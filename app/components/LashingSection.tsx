...
export default function LashingSection() {
  ...
  return (
    <div className="w-full transition-colors duration-300">
      ...
      {/* SECTION 1: Pengenalan Komoditas & Mitra Utama (Who & Product - Tepat Setelah Hero Section) */}
      <section id="eksplorasi" className="bg-white dark:bg-[#1A1B1D] px-5 sm:px-6 lg:px-8 py-24 md:py-32 scroll-mt-20">
        <div className="max-w-[1440px] mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-20 items-center">
          ...
          <div className="lg:col-span-7 space-y-6">
            ...
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-serif text-brand-charcoal leading-tight">
              ...
              <span className="text-brand-green-dark font-serif italic">Karya Kriya Berharga</span>
            </h2>
      ...
      <section id="wilayah" className="w-full bg-[#F5F4F0] dark:bg-[#121314] py-24 md:py-28 border-t border-brand-charcoal/5 scroll-mt-20">
        <div className="max-w-[1440px] mx-auto px-5 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
            {/* Card Jangli */}
            <div className="relative bg-white dark:bg-brand-charcoal p-8 sm:p-10 rounded-3xl border border-brand-charcoal/5 shadow-sm hover:border-[#2E5A44]/25 hover:shadow-xl hover:-translate-y-1 transition-all duration-500 ease-out group overflow-hidden">
              {/* Editorial Number */}
              ...
              <div className="pt-8 relative z-10">
                <Link
                  href="/jangli"
                  className="inline-flex items-center gap-2 text-sm font-bold text-brand-charcoal dark:text-brand-cream hover:text-[#2E5A44] dark:hover:text-brand-green-light transition-colors duration-300 group/btn"
                >
      ...
      <section className="w-full bg-[#F5F4F0] dark:bg-[#121314] py-24 md:py-28 border-t border-brand-charcoal/5">
        <div className="max-w-[1440px] mx-auto px-5 sm:px-6 lg:px-8 space-y-16">
          <div className="text-center max-w-3xl mx-auto space-y-4">
            <span className="inline-flex items-center gap-1.5 px-4 py-1.5 rounded-full text-xs font-semibold uppercase tracking-wider bg-[#2E5A44] text-[#F5F4F0] border border-[#2E5A44]/15 shadow-sm">
              <Compass className="h-3.5 w-3.5 text-brand-green-light" />
          ...
          {/* 2 Columns Grid for Solutions (White Cards on Cream Background) */}
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
            {solutions.map((sol, idx) => (
              <div
                key={idx}
                className="bg-white dark:bg-brand-charcoal border border-brand-charcoal/5 p-8 sm:p-10 rounded-3xl flex flex-col sm:flex-row gap-6 items-start hover:border-[#2E5A44]/25 hover:-translate-y-1.5 hover:shadow-xl transition-all duration-300 group shadow-sm"
              >
                <div className="h-12 w-12 rounded-2xl bg-[#2E5A44]/5 dark:bg-brand-green-light/5 flex items-center justify-center flex-shrink-0 shadow-sm border border-brand-charcoal/5 text-brand-green-dark dark:text-brand-green-light transition-transform duration-300 group-hover:scale-110">
                  {sol.icon}
                </div>
                <div className="space-y-2">
                  <h4 className="text-lg font-bold text-brand-charcoal dark:text-white font-sans">
                    {sol.title}
                  </h4>
                  <p className="text-sm text-brand-charcoal/65 dark:text-brand-cream/80 leading-relaxed font-sans">
                    {sol.desc}
                  </p>
                </div>
              </div>
