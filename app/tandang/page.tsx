...
const stats = [
  ...
  { value: "Sentra Kriya & Bank Sampah", label: "Potensi Utama" },
];

const pengrajin = [
  {
    id: 1,
    name: "Ibu Titin & Ibu Ponijah",
    role: "Sentra Pengrajin Tali Lashing — RW 10 (RT 04)",
    desc: "Tokoh pengrajin aktif turun-temurun di RT 4 RW 10 Tandang yang memproduksi tas anyaman lashing berkualitas tinggi dari bahan limbah tali plastik industri Polytron.",
    products: ["Tas Anyam Lashing", "Storage Box Geometris", "Tote Bag"],
  ...
  },
  {
    ...
    desc: "Pengrajin aktif di RT 3 RW 10 yang piawai membuat berbagai inovasi produk anyaman rumah tangga seperti pot gantung dan tudung saji dengan teknik anyaman silang presisi.",
    products: ["Pot Gantung Anyam", "Tudung Saji Elegan", "Table Runner"],
  ...
  {
    id: 3,
    name: "Ibu Indarwati & Pak Ruspartono",
    role: "Penggerak Bank Sampah & Sirkular — RW 03",
    desc: "Penasehat Bank Sampah dan Ketua RW 3 Tandang yang memimpin aktivitas pemilahan sampah 7 kategori hingga 100 kg serta menghidupkan kembali kerajinan daur ulang.",
    products: ["Kerajinan Daur Ulang", "Kas RT Bank Sampah", "Pupuk Kompos"],
...
const katalogProduk = [
  {
    ...
    desc: "Anyaman pot gantung estetis berdaya tahan tinggi terhadap cuaca ekstrem dan paparan sinar matahari, cocok untuk teras modern.",
    price: "Rp 45.000",
    color: "bg-[#5B9E31]/8",
  },
  {
    ...
    desc: "Wadah penyimpanan serbaguna dengan struktur anyaman rapat dan rangka yang kokoh untuk merapikan pakaian atau dokumen.",
    price: "Rp 75.000",
  ...
  },
  {
    ...
    desc: "Sajadah inovatif berbahan tali lashing yang kedap air, anti-lembab, praktis digulung, dan sangat mudah dibersihkan.",
    price: "Rp 60.000",
    color: "bg-[#2E5A44]/8",
  },
  {
    ...
    category: "Meja Makan",
    desc: "Pelindung hidangan keluarga dengan teknik anyaman silang presisi, menjaga kebersihan makanan dengan sirkulasi udara optimal.",
    price: "Rp 65.000",
  ...
  },
  {
    ...
    category: "Meja Makan",
    desc: "Taplak meja panjang bermotif kontemporer yang memberikan aksen mewah pada jamuan makan, tahan tumpahan air dan panas ringan.",
    price: "Rp 55.000",
    color: "bg-[#2E5A44]/8",
  },
  {
    id: 6,
    name: "Tas Tote Bag Lashing Premium",
    category: "Tas & Aksesoris",
    desc: "Tas anyaman tali lashing industri berdaya tampung besar dan modis, hasil pendampingan KKN untuk mendobrak pasar digital.",
    price: "Rp 85.000",
    color: "bg-brand-charcoal/5",
  },
];
...
const sosmasData = [
  ...
  { id: 4, name: "Daniswara Gita P.", title: "Integrasi Etalase Digital SETANJANG ke Marketplace Nasional", tag: "Teknologi", desc: "Pendampingan pembuatan toko online resmi UMKM Tandang di Shopee, Tokopedia, serta optimalisasi fitur WhatsApp Business." },
  ...
  { id: 12, name: "Mahasiswa KKN (Placeholder)", title: "Program Bimbingan Belajar & Literasi Anak Desa Tandang", tag: "Pendidikan", desc: "Pendampingan belajar interaktif bagi anak-anak usia sekolah dasar di sore hari serta pengenalan dasar daur ulang sejak dini." },
  { id: 13, name: "Mahasiswa KKN (Placeholder)", title: "Pemeriksaan Kesehatan Gratis & Lansia Sehat RW 03 & RW 10", tag: "Kesehatan", desc: "Pemeriksaan tekanan darah, gula darah, dan konsultasi pola hidup sehat bekerja sama dengan posyandu dan tokoh masyarakat setempat." },
  { id: 14, name: "Mahasiswa KKN (Placeholder)", title: "Penanaman Tanaman Obat Keluarga (TOGA) di Area Bank Sampah", tag: "Lingkungan", desc: "Pemanfaatan lahan kosong di sekitar balai RW 3 untuk ditanami berbagai tanaman obat keluarga yang bermanfaat bagi warga." },
  { id: 15, name: "Mahasiswa KKN (Placeholder)", title: "Dokumentasi & Pembuatan Video Profil Desa Ekosistem SETANJANG", tag: "Ekonomi Kreatif", desc: "Produksi video dokumenter dan profil potensi wisata kreatif desa yang menonjolkan kolaborasi sinergis Kelurahan Tandang." },
];
        ...
        <section className="relative min-h-screen flex items-center justify-center pt-20">
          ...
          <div className="relative z-10 max-w-4xl mx-auto px-6 sm:px-8 text-center flex flex-col items-center gap-8">
            ...
            <p className="text-base sm:text-lg text-white/80 max-w-2xl leading-relaxed">
              Mengenal lebih dekat sentra pengrajin tali lashing RW 10, revitalisasi Bank Sampah RW 3,
              katalog produk inovasi, program kerja, dan kegiatan sosial kemasyarakatan KKN Setanjang.
            </p>
            <a
              href="#profil-tandang"
