  ...
  return (
    <>
      ...
      <main className="flex-1 flex flex-col">
        {/* HERO SECTION JANGLI (Matching Home Hero Style) */}
        <section className="relative min-h-[92vh] flex items-center justify-center pt-20">
          ...
          {/* Placeholder for Jangli Hero Image */}
          {/* <Image src="/path-to-jangli-image.jpg" alt="Jangli Hero" fill className="object-cover object-center opacity-50" /> */}
          ...
          <div className="relative z-10 max-w-4xl mx-auto px-6 sm:px-8 text-center flex flex-col items-center gap-8">
            ...
            <p className="text-base sm:text-lg text-white/80 max-w-2xl leading-relaxed">
              Selamat datang di halaman khusus Kelurahan Jangli. Jelajahi berbagai program kerja,
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-0 rounded-3xl overflow-hidden border border-brand-charcoal/8">
              ...
              <div className="p-10 md:p-14 flex flex-col justify-center gap-6 bg-brand-cream">
                <p className="text-base text-brand-charcoal/65 leading-relaxed">
                  Kelurahan Jangli adalah kawasan strategis yang berfokus pada pemberdayaan
                  sumber daya manusia dan ekonomi kreatif. Warga di sini sangat antusias dalam
                  berkolaborasi menciptakan inovasi baru yang bermanfaat bagi lingkungan sekitar.
                </p>
                <p className="text-base text-brand-charcoal/65 leading-relaxed">
                  Fokus program KKN di Jangli meliputi literasi digital, perbaikan sanitasi
                  lingkungan, pengembangan pojok baca, serta inovasi teknologi tepat guna yang
                  bisa dimanfaatkan langsung oleh masyarakat.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="max-w-[1440px] mx-auto">
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-16">
              ...
              <p className="text-base text-brand-charcoal/60 leading-relaxed max-w-md">
                ...
                mendukung infrastruktur di Kelurahan Jangli.
              </p>
            </div>
          ...
          <div className="max-w-[1440px] mx-auto">
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-16">
              ...
              <p className="text-base text-brand-charcoal/60 leading-relaxed max-w-md">
                ...
                literasi, dan kesejahteraan sosial di Kelurahan Jangli.
              </p>
            </div>
          ...
          <div className="max-w-[1440px] mx-auto">
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-16">
              ...
              <p className="text-base text-brand-charcoal/60 leading-relaxed max-w-md">
                ...
                interaksi erat dengan masyarakat luas di Kelurahan Jangli.
              </p>
            </div>
